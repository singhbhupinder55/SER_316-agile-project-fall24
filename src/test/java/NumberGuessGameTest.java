...
class NumberGuessGameTest {
    ...
    void testAllValidGuesses() {
        ...
        assertEquals(5, game.processValidGuesses(guesses), "Expected all guesses to be counted as valid.");
    }
    ...
    void testAllInvalidGuesses() {
        ...
        assertEquals(0, game.processValidGuesses(guesses), "Expected no guesses to be counted as valid.");
    }
    ...
    void testMixOfValidAndInvalidGuesses() {
        ...
        assertEquals(3, game.processValidGuesses(guesses), "Expected only valid guesses to be counted.");
    }
    ...
    void testCalculateAverageWithValidGuesses() {
        ...
        assertEquals(20.0, game.calculateAverage(guesses), "Average of 10, 20, 30 should be 20.0");
    }
    ...
    void testCalculateAverageWithEmptySet() {
        ...
        assertEquals(0.0, game.calculateAverage(guesses), "Average of an empty set should be 0.0");
    }
    ...
    void testCalculateAverageSingleGuess() {
        ...
        assertEquals(10.0, game.calculateAverage(guesses), "Average of a single guess should be the guess itself, 10.0");
    }

    @Test
    @DisplayName("Test calculateAverage with null input")
    void testCalculateAverageNullInput() {
        assertNull(game.calculateAverage(null), "Null input should return null");
    }
    ...
    void testResetGame() throws GuessOutOfRangeException{
        ...
        assertEquals(0, game.Guess_count, "Guess count should be 0 after reset");
